...
openssl req  -newkey rsa:4096 -nodes  -keyout client-key.pem -out client-req.pem -subj "/C=VN/ST=Ha Noi/L=Ha Noi/O=PC Client/OU=Computer/CN=*.example.pcclient/emailAddress=pcclient@gmail.com"
